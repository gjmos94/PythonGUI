...
browsebtn = tk.Button(frame1, textvariable=browse_text, command=callCleanRev, font="helvetica 12 bold", bg="navy blue",
                      fg="gold", height=1, width=15)
browse_text.set("Run")
browsebtn.place(x=380, y=170)

browsebtn2 = tk.Button(frame2, textvariable=browse_text, command=callPaymatch, font="helvetica 12 bold", bg="navy blue",
                       fg="gold", height=1, width=15)
browse_text.set("Run")
browsebtn2.place(x=380, y=170)

browsebtn3 = tk.Button(frame3, textvariable=browse_text, command=callrevRaquel, font="helvetica 12 bold",
                       bg="navy blue", fg="gold", height=1, width=15)
browse_text.set("Run")
